...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Mostafijul Mollah") || (event.body.toLowerCase() == "mostafijul mollah") || (event.body.toLowerCase() == "@Mostafijulッ") || (event.body.toLowerCase() == "মোস্তাফিজুল")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Mostafijul ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 mostafijul.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :-https://www.facebook.com/share/194tPPiv98/ ?id=100015460351921\nতার সাতে যোগা যোগ করবেন WhatsApp :- 9230162543", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: Mostafijul Mollah ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস মোস্তাফিজুল আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Mostafijul ッ❤️ তাকে সবাই পিকু ,বৌদি লাভার ,নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami mostafijul") || (event.body.toLowerCase() == "cup sala ami mostafijul") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস মোস্তাফিজুল এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "June") || (event.body.toLowerCase() == "june")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস মোস্তাফিজুল এর গুরু জি এর নাম..!😠⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "papri") || (event.body.toLowerCase() == "papri")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস মোস্তাফিজুল এর পাপোর আপুর এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Muskan") || (event.body.toLowerCase() == "muskan")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস মোস্তাফিজুল এর এক্স এর নাম..!😠⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Tropa kormokar") || (event.body.toLowerCase() == " Tropa")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস মোস্তাফিজুল'র রাশিয়ান বৌদি লাগে লুচ্ছি বেডি'রা দূরে থাক😠⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "KISS ME") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessage("️ তুমি পঁচা তোমাকে কিস দিবো না । তোমার নাকি কে অলাবু থু উম্মমমমমমমমমমমমমমমমমমমমমমমমমমমমমমাহ 👄💋💋💋💋💋💋💋 🤭", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁 , made to Mostafijul mollah", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😹")) {
     return api.sendMessage(" তুমি এত হেসো না প্রেম ও পরে যাবো তো.!🌚👀🙈 হাসেলে তোমাকে অনেক কিউট লাগে ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage(" i love unlimited jan 💋👀🙈 ummmah 💋 tomr lips a 👀💋", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami mostafijul") || (event.body.toLowerCase() == "kire")) {
